...
@Document
public class user_profiles_keliri {
	 ...
	 @Id
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			user_profiles_keliri other = (user_profiles_keliri) obj;
		...
		public String toString() {
			return "user_profiles_keliri [id=" + id + ", userId=" + userId + ", profilePicture=" + profilePicture
					+ ", createdBy=" + createdBy + ", updatedBy=" + updatedBy + ", createdAt=" + createdAt + "]";
		}
		public user_profiles_keliri(ObjectId userId, ObjectId profilePicture, ObjectId createdBy, ObjectId updatedBy,
				Date createdAt) {
			super();
