...
export default function ResetPassword() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            // Reusing the same endpoint as it handles password setting by token
        ...
        return (
            <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
                <div className="max-w-md w-full bg-white rounded-3xl shadow-xl shadow-slate-200/50 p-8 text-center animate-fade-in">
                    ...
                    <h1 className="text-2xl font-bold text-gray-900 mb-2">Account Recovered!</h1>
                    <p className="text-gray-500 mb-8">Your password has been reset and your account is now unlocked.</p>
                    <button onClick={() => navigate('/')} className="btn-primary w-full shadow-lg shadow-primary-600/20">
                ...
                <div className="mb-8 text-center">
                    <div className="inline-flex items-center gap-3 bg-white px-5 py-3 rounded-2xl shadow-sm border border-slate-100 group hover:border-primary-200 transition-all duration-300">
                        ...
                        <span className="text-2xl font-black tracking-tight text-slate-800">
                            KELIRI <span className="text-primary-600">SECURITY</span>
                        </span>
                    </div>
                </div>

                <div className="bg-white rounded-[2rem] shadow-2xl shadow-slate-200/60 border border-slate-100 overflow-hidden relative">
                    <div className="absolute top-0 left-0 w-full h-1.5 bg-gradient-to-r from-red-400 via-primary-600 to-red-400 animate-gradient-x"></div>

                    <div className="p-8 sm:p-10">
                        <div className="mb-8">
                            <h1 className="text-3xl font-bold text-slate-900 mb-2">Reset Password</h1>
                            <p className="text-slate-500 text-sm font-medium">Set a new secure password to unlock your account and regain access.</p>
                        </div>
                    ...
                    <div className="px-8 py-6 bg-slate-50 border-t border-slate-100 text-center text-[10px] text-slate-400 uppercase tracking-widest leading-loose">
