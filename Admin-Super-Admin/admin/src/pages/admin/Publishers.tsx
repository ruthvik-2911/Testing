...
export default function Publishers() {
  ...
  const loadData = React.useCallback(async () => {
    setLoading(true)
    try {
      // Check if Super Admin - show all publishers without company filter
      ...
      if (userStr) {
        ...
        // Super Admin check - if email is admin@keliri.com, show all publishers
        if (user.email === 'admin@keliri.com') {
          console.log('🔥 Super Admin detected - showing ALL publishers globally');
          companyUID = undefined; // No company filter for Super Admin
        } else {
      ...
      if (userEmail === 'admin@keliri.com') {
        console.log(`✅ Super Admin: Loaded ${response.totalItems} global publishers`);
      } else {
        console.log(`✅ Admin: Loaded ${response.totalItems} company publishers`);
      }
    } catch (error) {
